    ...
    <div className="d bg-sky-600">
      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        <div className="absolute inset-x-0 -top-40 -z-10 transform-gpu overflow-hidden blur-3xl sm:-top-80" aria-hidden="true">
          <div
            className="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#ffffff] to-[#0004ff] opacity-30 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"
            style={{
              clipPath:
        ...
        <div className="mx-auto max-w-5xl py-32 sm:py-48 lg:py-56">
          <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
            <div className="text-left">
              ...
              <h2 className="mt-4 text-xl font-semibold text-gray-100 sm:text-2xl">Fullstack Developer, API-Enthusiast</h2>

              <p className="mt-6 text-lg max-w-lg leading-8 text-gray-200">
                I'm a developer with a passion for working with APIs to create innovative applications that solve complex
                problems.
              </p>
