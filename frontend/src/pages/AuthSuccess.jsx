            ...
            <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
              <div className="lg:pr-8 lg:pt-4">
                <div className="lg:max-w-lg">
                  <h2 className="text-base font-semibold leading-7 text-fuchsia-500">Congrats!</h2>
                  <p className="mt-2 text-3xl font-bold tracking-tight text-white sm:text-4xl">Successfully Authorized</p>
                  <p className="mt-6 text-lg leading-8 text-white">
                    You can now close this window and go back to the main page. If you are not redirected automatically, click one
                  ...
                  <div className="mt-10 max-w-xl space-y-8 text-base leading-7 text-white lg:max-w-none">
                    <div className="mt-10 text-left max-sm:text-center">
                      <div className="max-sm:flex max-sm:flex-col max-sm:items-center max-sm:gap-4 lg:flex-row lg:gap-4">
                        ...
                        <a
                          href="/"
                          className="md:ml-10 mt-4 sm:mt-0 sm:ml-0 lg:mt-0 lg:ml-10 rounded-md cursor-pointer bg-blue-600 px-7 py-3 text-md font-semibold text-white shadow-sm hover:bg-blue-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                        >
                          Home Page
                        </a>
                      </div>
              ...
              <CheckBadgeIcon color="green" className="w-3/4 h-3/4 m-auto" />
            </div>
          </div>
        </div>
      </div>
